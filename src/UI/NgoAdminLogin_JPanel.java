 ...
 * @author pikku
 */
public class NgoAdminLogin_JPanel extends javax.swing.JPanel {

    /**
     * Creates new form NgoAdminLogin_JPanel
     */
    int department_id = 1;
    JPanel controlArea;
    JPanel workArea;

    public NgoAdminLogin_JPanel(JPanel controlArea, JPanel workArea) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelTitile.setText("NGO STUDENT ADMIN LOGIN");
        ...
        if (email.isEmpty()) {
            ...
            try {
                ...
                if (!res.isBeforeFirst()) {
                    ...
                    while (res.next()) {
                        if (department.equals("Homeless Department")) {
                             workArea.removeAll();
