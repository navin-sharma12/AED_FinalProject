...
public class Housing_AssignHousing_JPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnFetch.setBackground(new java.awt.Color(255, 255, 255));
        btnFetch.setFont(new java.awt.Font(".AppleSystemUIFont", 3, 12)); // NOI18N
        btnFetch.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jLabel2.setText("                     Housing - Assign Housing");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/housing 1.jpeg"))); // NOI18N
            ...
            while (rs.next()) {
                ...
                while (rs_housing.next()) {
                    Object[] row = new Object[4];
                     System.out.println(rs_housing.getString(7));
