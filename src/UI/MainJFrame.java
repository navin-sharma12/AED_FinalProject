...
//        layout.next(workArea); 
       ...
       Funding_UpdateLocalInvestor_JPanel frijp = new Funding_UpdateLocalInvestor_JPanel(controlArea, workArea);
        workArea.add("Funding_UpdateLocalInvestor_JPanel",frijp);
        CardLayout layout = (CardLayout)workArea.getLayout();
        layout.next(workArea);
