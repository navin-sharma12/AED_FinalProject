...
public class Funding_ManageInvestors_Read extends javax.swing.JPanel {
    ...
    private void jButtonFetchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonFetchActionPerformed
        ...
        {
            Logger.getLogger(Funding_ManageInvestors_Read.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try
        {
            while(resultSet.next())
            {
                if(resultSet.getString(3).equals(table_model.getValueAt(selectedRowIndex, 0)))
                {
                    ...
                    if(resultSet.getString(6).equals("Local Investor"))
                    {
                        jComboBoxDepartment.setSelectedItem(1);
                    }
                    if(resultSet.getString(6).equals("Government Organization"))
                    {
